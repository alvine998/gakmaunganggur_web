...
const mockJobData = {
  ...
  description: "Kami mencari Senior Frontend Developer yang berpengalaman untuk bergabung dengan tim teknologi kami. Anda akan bertanggung jawab dalam mengembangkan dan memelihara aplikasi web yang digunakan oleh jutaan pengguna.",
  requirements: [
...
export default function UpdateJobPage() {
  ...
  if (showSuccess) {
    return (
      <>
        <Head>
          <title>Lowongan Berhasil Diperbarui - KerjaAjaDulu.com</title>
        ...
        <CompanyLayout activePage="jobs">
          <div className="max-w-2xl mx-auto text-center py-20">
            ...
            <p className="text-gray-500 mb-8">
              Perubahan telah disimpan. Sedang mengarahkan ke detail lowongan...
            </p>
            <Link
  ...
  return (
    <>
      <Head>
        <title>Edit Lowongan - KerjaAjaDulu.com</title>
        <meta name="description" content="Edit lowongan kerja" />
        <meta name="viewport" content="width=device-width, initial-scale=1" />
        <link rel="icon" href="/favicon.ico" />
      </Head>
