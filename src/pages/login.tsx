...
export default function Login() {
  ...
  return (
    <>
      <Head>
        <title>Login - KerjaAjaDulu.com</title>
        <meta name="description" content="Login untuk pencari kerja di KerjaAjaDulu.com" />
          ...
          <div className="w-full max-w-md">
            ...
            <div className="bg-white rounded-3xl shadow-xl p-8 border border-gray-100">
              ...
              <p className="text-gray-500 text-center mb-8">
                Masukkan kredensial Anda untuk menemukan pekerjaan impian
              </p>
